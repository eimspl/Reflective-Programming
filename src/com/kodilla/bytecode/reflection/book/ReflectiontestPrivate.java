...
public class ReflectiontestPrivate {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException,
        ...
        System.out.println("Initial value of signature: " + book.getSignature());
        System.out.println("Initial value of year: " + book.getYear());

        Field signatureField = Book.class.getDeclaredField("signature");
        signatureField.setAccessible(true);

        String value = (String) signatureField.get(book);
        System.out.println("Value of private field signature: " + value);
        ...
        System.out.println("Result of invoked private method rentBook: " + result);
        ...
        System.out.println("Signature set via private method setDetails: " + book.getSignature());
        System.out.println("Year set via private method setDetails: " + book.getYear());
    }
